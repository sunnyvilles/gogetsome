...
var FilterPanel = Backbone.View.extend({
	initialize : function(config){
		...
		this.template = _.template([
			...
			'<li><a class="cat cat1" data-category="48"><span></span><div>Blue</div></a></li>',
			'<li><a class="cat cat2" data-category="126"><span></span><div>Shirt</div></a></li>',
			'<li><a class="cat cat3" data-category="3"><span></span><div>Sports Wear</div></a></li>',
			'<li><a class="cat cat4" data-category="78"><span></span><div>Black</div></a></li>',
			'<li><a class="cat cat5" data-category="74"><span></span><div>Spykar</div></a></li>',
			'<li><a class="cat cat6" data-category="5"><span></span><div>Men</div></a></li>',
			'<li><a class="cat cat7" data-category="27"><span></span><div>Women</div></a></li>',
			'<li><a class="cat cat7" data-category="7"><span></span><div>PUMA</div></a></li>',
			'</ul>',
			'</div>',
			'</li>',
			'<li>',
	...
	sort : function(sortBy,el){
		$('a::before',el).addClass('ascending');
		app.setSortOrder({
			sortBy : sortBy
		});
